                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table id="myProjectTable" class="table table-hover align-middle mb-0 nowrap dataTable no-footer dtr-inline" style="width: 100%;" role="grid" aria-describedby="myProjectTable_info">
                                                    ...
                                                    <c:forEach var="taskHistory" items="${taskHistoryList}">
                                                        <form method="post" action="taskHistory">
                                                        <tr role="row" class="odd">
                                                            <td tabindex="0" class="sorting_1">
                                                                <a href="#" class="fw-bold text-secondary">#${taskHistory.task.id}</a>
                                                            </td>
                                                            <td>${taskHistory.task.title}</td>

                                                            <td>
                                                                <img class="avatar rounded-circle" src="./admin/__ My-Task__ Tickets_files/avatar4.jpg" alt="">
                                                                <span class="fw-bold ms-1">${taskHistory.task.assigneeTo.username}</span>
                                                            </td>
                                                            <td>
                                                                <label>
                                                                    <select name="newUser" class="form-control">
                                                                        <c:forEach var="user" items="${userList}">
                                                                            <c:if test="${taskHistory.task.assigneeTo.id != user.id}">
                                                            ...
                                                            <td>
                                                                <label>
                                                                    <select name="isNeedNewTask" class="form-control">
                                                                        <option value="false">No task to assignee</option>
                                                                        <option value="true">Creat New Task</option>
                                                                    </select>
                                                                </label>
                                                            </td>
                                                            <td>
                                                                <input type="hidden" name="taskId" value="${taskHistory.task.id}">
                                                                <input type="hidden" name="taskHistoryId" value="${taskHistory.id}">

                                                                <button class="btn btn-success" value="saveApprove" name="action" type="submit">
                                                                    Approve
                                                                </button>
