                        ...
                        <form action="Task" method="post">
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" value="${task.title}" placeholder="Title ..." class="form-control" id="sub">
                                </div>
                                <div class="deadline-form">
                                        <div class="row g-3 mb-3">
                                            <div class="col">
                                                <label for="deptwo2" class="form-label">Creted Date</label>
                                                <input type="date" value="${task.creationDate}" name="creationDate" class="form-control" id="deptwo2">
                                            </div>
                                            <div class="col">
                                                <label for="deptwo" class="form-label">End Date</label>
                                                <input type="date" value="${task.endDate}" name="endDate" class="form-control" id="deptwo">
                                            </div>
                                        </div>
                                </div>
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col">
                                            ...
                                            <select class="form-select" name="assigneeTo_id">
                                                <c:forEach var="users" items="${userList}">
                                                    <option value="${users.id}" ${users.id == task.assigneeTo.id ? 'selected' : ''}>${users.username}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col">
                                            ...
                                            <select class="form-select" id="status" name="isCompleted">
                                                <option value="COMPLETED" ${task.isCompleted=='COMPLETED' ? 'selected' : ''}>Completed</option>
                                                <option value="EN_PROGRESS" ${task.isCompleted=='EN_PROGRESS' ? 'selected' : ''}>En Progress</option>
                                                <option value="CANCELLED" ${task.isCompleted=='CANCELLED' ? 'selected' : ''}>Cancelled</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <select class="form-control" name="tages[]" multiple data-coreui-search="true">
                                        <c:forEach var="tage" items="${tagesList}">
                                            <option value="${tage.id}"
                                                    <c:forEach var="selectedTag" items="${task.tages}">
                                                        <c:if test="${tage.id == selectedTag.id}">
                                                            selected="selected"
                                                        </c:if>
                                                    </c:forEach>
                                            >${tage.name}</option>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="description" class="form-control" id="addnote" rows="3">${task.description}</textarea>
                                </div>
                            </div>
                            <div class="modal-footer mt-3">
                                <input type="hidden" name="idTask" value="${task.id}">
                                <button type="submit" name="actionType" value="updateTask" class="btn btn-primary">Update Task</button>
                            </div>
                        </form>
                    </div>
