                                    ...
                                    <div class="row g-3 mb-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <select class="form-select" id="status" name="isCompleted">
                                                <option value="true" ${task.isCompleted=='COMPLETED' ? 'selected' : ''}>Completed</option>
                                                <option value="false" ${task.isCompleted=='EN_PROGRESS' ? 'selected' : ''}>En Progress</option>
                                                <option value="false" ${task.isCompleted=='CANCELLED' ? 'selected' : ''}>Cancelled</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
